...
export const scrape = async (urlind, index) => {
  try {
    ...
    await fs.writeFile(`Data_page${index}.json`, jsonData);
    console.log(`Data has been written to Data_page${index}.json`);
